<%@ Page Title="" Language="C#" MasterPageFile="~/footer.master" AutoEventWireup="true" CodeFile="news-details.aspx.cs" Inherits="news_details" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tagline-message page-title text-center">
                            <h3 id="titleBigHtml" runat="server">News</h3>
                            <ul class="breadcrumb">
                                <li><a href="default.aspx">Home</a></li>
                                <li id="titleSmallHtml" runat="server" class="active">News</li>
                            </ul>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="content blog-list">
                                <div id="newsHtml" runat="server" class="blog-wrapper clearfix">
                                    <div class="blog-meta">
                            ...
                            <div class="authorbox">
                                <div id="simularNewsHtml" runat="server" class="site-publisher clearfix">
                        ...
                        <div class="sidebar col-md-4">
                            <div class="widget clearfix">
                                ...
                                <div id="recentNewsHtml" runat="server"  class="post-widget">
                                    <div class="media">
