<%@ Page Language="C#" AutoEventWireup="true" CodeFile="terms-f.aspx.cs" Inherits="dashboard_login" %>
...
<body>
    <form id="form1" runat="server" style="min-height: 100vh; padding: 0; margin: 0;">
        <div class="wrapper">
            <div class="container">
                <h2 class="farsi-title">شرایط و قوانین:</h2>
                        ...
                        <div class="col-lg-12">
                            <div>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <blockquote class="blockquote text-right">
                                          ...
                                          <footer class="blockquote-footer">پاتوقکده <cite title="شرایط و قوانین">شرایط و قوانین عضویت</cite></footer>
                                        </blockquote>    
                                    </div>
                                </div>
                                ...
                                <div class="fa-style form-group">
                                    <button type="button" class="btnEnter" onclick="document.location = 'register.aspx'" >صفحه ثبت نام</button>
                                </div>
                            </div>
                        </div>
                    </div>
