<%@ Page Title="" Language="C#" MasterPageFile="~/footer.master" AutoEventWireup="true" CodeFile="product-category.aspx.cs" Inherits="product_category" %>
            ...
            <div class="container">
                <div class="boxed boxedp4">
                    <div class="shop-top">
                        <div class="clearfix">
                            <div class="pull-left">
                                <p id="productAmountHtml" runat="server"> Showing 1–9 of 11 results</p>
                            </div>
                    ...
                    <div id="productHtml" runat="server" class="row blog-grid shop-grid">
                        <div class="col-md-3">
                    ...
                    <div class="row text-center">
                        <div class="col-md-12">
                            <ul id="pagingHtml" runat="server" class="pagination">
