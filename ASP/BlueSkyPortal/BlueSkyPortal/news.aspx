<%@ Page Title="" Language="C#" MasterPageFile="~/footer.master" AutoEventWireup="true" CodeFile="news.aspx.cs" Inherits="news" %>
    ...
    <section class="top-title-others section lb p120">
        ...
        <section class="section gb nopadtop">
            <div class="container">
                <div class="boxed">
                    <div class="row">
                        <div id="newsHtml" runat="server" class="col-md-8">
